        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/4">
            <div className="sticky top-24 p-6 rounded-2xl bg-slate-50 border border-outline">
              ...
              <div className="flex gap-4">
                <button className="flex-1 p-3 rounded-xl border border-outline hover:bg-white hover:shadow-sm transition-all flex items-center justify-center text-primary">
                  <Share2 size={20} />
                </button>
                <button className="flex-1 p-3 rounded-xl border border-outline hover:bg-white hover:shadow-sm transition-all flex items-center justify-center text-primary">
                  <BookOpen size={20} />
          ...
          <div className="lg:w-3/4">
            ...
            <div className="mt-12 pt-12 border-t border-outline">
              <h4 className="font-black text-primary text-xl mb-6">Continue Learning</h4>
